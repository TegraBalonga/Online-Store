                ...
                <div class="col-2">
                    <div class="form-container">
                        ...
                        <form id="LoginForm" runat="server" method="post">
                            <input id="loginUsername" type="text" placeholder="Username" runat="server" />
                            <input id="loginPass" type="password" placeholder="Password" runat="server" />
                            <br><br>
                            <asp:Label ID="lblError" runat="server" Text="Username or password entered is incorrect" Font-Size="Small" Width="234px"></asp:Label>
                            <br><br>
                            <button id="btnLogin" class="btn" runat="server" onserverclick="btnLogin_Click">Login</button>

                            <a href="">Forgot password</a>
                            <br>
                            <br>
                            <a href="SignIn.aspx">Don't have an account yet? Click me</a>
